...
SELECT * FROM employees WHERE first_name IN ('Irena','Maya','Vidya') ORDER BY last_name,first_name;
...
SELECT DATEDIFF(curdate(),hire_date),first_name,last_name,hire_date FROM employees WHERE YEAR(hire_date) BETWEEN 1990 AND 1999 AND MONTH(birth_date)=12 AND day(birth_date)=25;
